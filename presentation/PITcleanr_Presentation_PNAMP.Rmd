...
include_graphics(here("presentation",
                      "images",
...
.pull-left[
* Uses `r include_graphics(here("presentation", "images", "Rlogo.png"), dpi = 2500)`
...
???
You may not need all this functionality for every analysis
...
???
Note yellow highlighting indicates `PITcleanr` functions
...
Duration and Travel Time are in minutes

Add up N Dets = # rows in original data
...
1. Assign (or map) observations to node of your choice
...
???
Config ID is because sites can change configuration over time
...
* Tags move from parent sites to child sites

* Default is to tell which sites are upstream of a particular site
